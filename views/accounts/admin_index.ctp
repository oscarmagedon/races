<div class="sports index">
	...
	<button id="addacc" href="<?php echo $html->url(array("action"=>"add", $profileId)) ?>"> 
...
<script>
$(function(){
	var filt_url = '<?php echo $html->url(array("controller"=>"accounts","action"=>"index/")) ?>';
