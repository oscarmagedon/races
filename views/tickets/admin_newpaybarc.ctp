...
<div class="tickets">
	<h2>Pagar Ticket CODEBAR</h2>
	<?php 
	echo $form->create('Ticket',array('action'=>'newpaybarc'));

	echo $form->input('allbarcode',array('style'=>'width: 200px; font-size:120%',
                'label'=>'BUSCAR...'));
			...
			<table>
				...
				<tr>
					...
					if($ticket['Ticket']['payed_status_id'] == 1){
						...
						echo $form->input('confirm',array('type'=>'text','readonly'=>true,
                            'style'=>"font-size: 130%;",'value'=>$ticket['Ticket']['confirm']));
						echo $form->end(" PAGAR ",array('style'=>"font-size: 160%; font-weight:bold"));
					}
					?>
					</td>
				</tr>
