...
<div class="tickets">
<h2>Anular Ultimo Ticket</h2>	
	<div style="clear:both"> </div>
	<div style="clear:none; float:left; width:300px; margin-top:10px; margin-left:10px">
		<?php
		if(!empty($ticket)){
		?>
	...
	if($err_line != ""){
	?>
		<span style="font-size:150%;font-weight:bold; color:red"><?php echo $err_line?></span>
	<?php
	}else{
		echo $form->create('Ticket',array('action'=>'anull_last'));
